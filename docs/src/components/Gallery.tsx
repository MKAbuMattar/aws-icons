  ...
  return (
    <div className="fe-gallery not-content">
      <style>{`
        ...
        .fe-dialog .fe-titles {flex: 1; min-width: 0;}
      ...
      <dialog
        ...
        aria-label={current ? `${current.name} usage` : 'Usage'}
      >
        {current && (
          <>
            <header className="fe-head">
              <span className="fe-tile">
                <InlineIcon url={url(current.slug)} size={36} />
              </span>
            ...
            <section className="fe-code">
              <div className="fe-code-head">
                <span>
                  {activeSnippet?.label} · {current.slug}
                </span>
                <button
                  type="button"
                  className="fe-copy"
              ...
              {/* biome-ignore lint/a11y/noNoninteractiveTabindex: scrollable code region must be keyboard reachable */}
              <pre tabIndex={0}>
