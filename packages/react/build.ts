/**
 * Generates one ESM icon module + d.ts per icon per style from assets/,
 * plus a tree-shakeable index per style. The runtime core (createAwsIcon)
...
console.log(`@aws-icons/react: generated ${total} icon components`);
